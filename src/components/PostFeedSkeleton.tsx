  ...
  return (
    <div className="w-full flex flex-col bg-transparent pt-4 rounded-lg mb-4">
      ...
      <div className="mb-6 border-b border-white/25 pb-4">
        <div className="pl-4">
          <div className="h-8 w-20 bg-gray-700/50 rounded mb-4"></div>
        <div className="h-12 w-full bg-gray-700/50 rounded mb-3"></div>
        </div>
      </div>
        ...
        {[...Array(3)].map((_, index) => (
          <div key={index} className="p-4 border-b border-white/25 ">
            <div className="flex items-center mb-4">
              <div className="bg-gray-700/50 h-10 w-10 border border-white/25 rounded-full"></div>
              <div className="ml-3">
                <div className="h-5 w-24 bg-gray-700/50 rounded mb-1"></div>
